...
// Data
import data from "layouts/Project/data/bugData";
...
function Bugs() {
  const { columns, rows, bugCompleted } = data();
        ...
        <MDBox>
          ...
          <MDBox display="flex" alignItems="center" lineHeight={0}>
            ...
            <MDTypography variant="button" fontWeight="regular" color="text">
              &nbsp;<strong>{bugCompleted}</strong> completed this month
            </MDTypography>
          </MDBox>
        </MDBox>
        ...
        <MDBox display="flex" sx={{ alignItems: "center !important" }} px={2}>
          ...
          <MDBox ml={2}>
            <MDButton
              ...
              onClick={() =>
                navigate(
                  `/project/${encodeURIComponent(localStorage.getItem("projectName"))}/bugs/create`
                )
              }
              variant="outlined"
              size="small"
