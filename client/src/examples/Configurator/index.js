...
function Configurator(notifications = [], setNotifications) {
  ...
  const renderInfoSB = (notify) => (
    <MDSnackbar
      icon={notify?.iconType === "info" ? "notifications" : ""}
      title={notify?.title}
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      <MDBox display="flex" justifyContent="space-between" alignItems="baseline" pt={4} pb={0.5}>
        <MDBox>
